...
extension UIFont {
    ...
    enum Font: String {
        case ChosunCentennial, EBS훈민정음L, EBS훈민정음R, EBS훈민정음SB, Eulyoo1945, UhBeemysen, UhBeeSeulvely, Chalkduster, BMEuljiro10yearslaterOTF, NanumBarunGothic
